...
// It places the pre-built fixture tree from testdata/wpgithub_tests.
...
func seedWPRepo(t *testing.T) string {
	...
	return filepath.Join("testdata", "wpgithub_tests")
}

// ---------------------------------------------------------------------------
// Test 1 — NewWPGithubSource construction and identity
// ---------------------------------------------------------------------------

// TestNew_ConstructsWithRepoPath verifies that New returns a non-nil
// WPGithubSource with the correct repoPath set, and that ID() and Meta()
...
// TestNew_ImplementsSourceInterface ensures WPGithubSource satisfies the
// source.Source interface at compile time. The var _ assertion in wpgithub.go
